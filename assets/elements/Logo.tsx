...
interface Props {
  hasAlwaysFullLogo?: boolean;
}

export const Logo: React.FC<Props & BoxProps> = ({
  hasAlwaysFullLogo,
  ...props
}) => {
  const showSmallLogo = useBreakpointValue({
    base: false,
    xl: hasAlwaysFullLogo ? true : false
    // xl: false
  });
  ...
  return (
    <NextChakraLink
      ...
      color='black'
    >
      {showSmallLogo ? <LogoMobileSvg {...props} /> : <LogoSvg {...props} />}
    </NextChakraLink>
  );
};

export const LogoCircle: React.FC<BoxProps> = ({ ...props }) => {
  return (
    <NextChakraLink
      href={'/'}
      pointerEvents='auto'
...
export const LogoSvg: React.FC<BoxProps> = props => {
  return (
    <Box w={{ base: 36 }} {...props}>
      <AspectRatio ratio={136 / 40}>
        <Box
          as='svg'
...
export const LogoMobileSvg: React.FC<BoxProps> = props => {
  return (
    <Box w={{ base: 12 }} color='black' {...props}>
      <AspectRatio ratio={1}>
        <Box
          as='svg'
          xmlns='http://www.w3.org/2000/svg'
